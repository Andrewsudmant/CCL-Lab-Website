...
- ORCID groups: 54
- Complete verified public records: 46
- Selected publications and outputs: 10
- ORCID-only records resolved through authoritative sources: 9
- ORCID records excluded after authoritative authorship check: 1
- Unresolved ORCID-only records withheld: 10
...
The unresolved CSV retains 10 ORCID-only groups without inventing public
