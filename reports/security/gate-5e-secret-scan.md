...
The post-commit non-disclosing scanner completed with exit status 0 and zero credential-pattern findings across 1,512 reachable Git blobs and 658 present files. It checked private-key headers and recognizable OpenAI, GitHub, AWS, Slack, Stripe and Google credential formats without printing candidate values.
