...
def source_record(item: dict, fixture: dict) -> dict:
    ...
    return {
        ...
        "discovery": {"adapter": "openalex" if not item["fixture"] else "captured-web-fixture", "query_id": "cc-fixture-" + (item["theme"] or "unclassified"), "query_version": "current-conversations-v2.0.0", "run_id": "thematic-reframe-mixed-source-captured"},
...
def build() -> tuple[list[dict], list[dict]]:
    ...
    for key, members in grouped.items():
        ...
        clusters.append({
            ...
            "ai_provenance": {"used": False, "model": None, "prompt_version": "current-conversations-classification-v1-fixture", "run_id": "thematic-reframe-mixed-source-captured"},
