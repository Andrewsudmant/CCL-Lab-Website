...
BOUNDED = [
    ...
    "reports/qa/gate-5h-final/validate.log",
    "reports/qa/gate-5h-final/test.log",
    "reports/qa/gate-5h-final/build.log",
    "reports/qa/gate-5h-final/check.log",
    "reports/qa/gate-5h-final/release-check.log",
